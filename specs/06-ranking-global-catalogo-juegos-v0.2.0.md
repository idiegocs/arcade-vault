...
11. Actualizar `package.json` (`"version": "0.2.0"`) y `components/nav.tsx`: el `Footer` deja de tener el string hardcodeado `v2.6.0` y muestra `v${version}` leído de `package.json`. Test manual: el footer de cualquier página muestra "v0.2.0".
